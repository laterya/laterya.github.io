...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "代码、产品与长期项目的个人记录",

	// 站点 URL
	site_url: "https://laterya.github.io",

	// 站点描述
	description:
		"一个基于 Astro 与 Firefly 主题构建的个人博客，用来记录工程实践、产品观察与长期项目。",
	...
	navbar: {
		...
		logo: {
			type: "icon",
			value: "material-symbols:ink-pen-outline-rounded",
			alt: "Laterya Notes",
		},
		// 导航栏标题
		title: "Laterya Notes",
